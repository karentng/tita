...
class Cursos(models.Model):
    ...
    SEDES = (
        ...
        ('Principal LA CUMBRE - IE SIMON BOLIVAR CABECERA MUNICIPAL - SEDE PRINCIPAL', 'Principal LA CUMBRE - IE SIMÓN BOLIVAR CABECERA MUNICIPAL - SEDE PRINCIPAL'),
        #dagua
        ...
        ### BILINGUISMO COHORTE 2


        ('INEM JORGE ISAACS',
            (('Principal INEM JORGE ISAACS', 'Principal INEM JORGE ISAACS'),
            ('Satelite CECILIA MUNOZ RICAURTE',  'Satelite CECILIA MUÑOZ RICAURTE'),
            ('Satelite LAS AMERICAS',  'Satelite LAS AMERICAS'),
            ('Satelite CAMILO TORRES',  'Satelite CAMILO TORRES'),
            ('Satelite CENTRO EDUCATIVO DEL NORTE',  'Satelite CENTRO EDUCATIVO DEL NORTE'),
            ('Satelite FRAY DOMINGO DE LAS CASAS',  'Satelite FRAY DOMINGO DE LAS CASAS'),
            ('Satelite PABLO EMILIO',  'Satelite PABLO EMILIO'))),
        ('ANTONIO JOSE CAMACHO',
            (('Principal ANTONIO JOSE CAMACHO', 'Principal ANTONIO JOSE CAMACHO'),
            ('Satelite REPUBLICA DEL PERU', 'Satelite REPUBLICA DEL PERU'),
            ('Satelite MARCO FIDEL SUAREZ', 'Satelite MARCO FIDEL SUAREZ'),
            ('Satelite OLGA LUCIA LLOREDA', 'Satelite OLGA LUCIA LLOREDA'))),
        ('NORMAL. SUPERIOR SANTIAGO DE CALI',
            (('Principal NORMAL. SUPERIOR SANTIAGO DE CALI', 'Principal NORMAL. SUPERIOR SANTIAGO DE CALI'),
            ('Satelite JOAQUIN DE CAYZEDO Y CUERO',  'Satelite JOAQUIN DE CAYZEDO Y CUERO'))),
        ('GOLONDRINAS PRINCIPAL',
            (('Principal GOLONDRINAS PRINCIPAL', 'Principal GOLONDRINAS PRINCIPAL'),
            ('Satelite ANTONIO BARBERENA',  'Satelite ANTONIO BARBERENA'))),
        ('CARLOS HOLGUIN MALLARINO',
            (('Principal CARLOS HOLGUIN MALLARINO', 'Principal CARLOS HOLGUIN MALLARINO'),
            ('Satelite NINO JESUS DE ATOCHA',  'Satelite NIÑO JESUS DE ATOCHA'),
            ('Satelite MIGUEL DE POMBO',  'Satelite MIGUEL DE POMBO'))),
        ('MANUEL MARIA MALLARINO',
            (('Principal MANUEL MARIA MALLARINO', 'Principal MANUEL MARIA MALLARINO'),
            ('Satelite LAURA VICUNA', 'Satelite LAURA VICUÑA'),
            ('Satelite LOS PINOS', 'Satelite LOS PINOS'),
            ('Satelite CARLOS HOLGUIN SARDI', 'Satelite CARLOS HOLGUIN SARDI'))),
        ('EL DIAMANTE',
            (('Principal EL DIAMANTE', 'Principal EL DIAMANTE'),
            ('Satelite JUAN PABLO II', 'Satelite JUAN PABLO II'))),
        ('EUSTAQUIO PALACIOS',
            (('Principal EUSTAQUIO PALACIOS', 'Principal EUSTAQUIO PALACIOS'),
            ('Satelite    LUIS LOPEZ MESA', 'Satelite    LUIS LOPEZ MESA'),
            ('Satelite    CELANESE', 'Satelite    CELANESE'),
            ('Satelite    MANUEL MARIA BUENAVENTURA', 'Satelite    MANUEL MARIA BUENAVENTURA'),
            ('Satelite    MARISCAL JORGE ROBLEDO', 'Satelite    MARISCAL JORGE ROBLEDO'),
            ('Satelite    MIGUEL ANTONIO CARO', 'Satelite    MIGUEL ANTONIO CARO'),
            ('Satelite    GENERAL ANZOATEGUI', 'Satelite    GENERAL ANZOATEGUI'),
            ('Satelite    TULIO ENRIQUE TASCON', 'Satelite    TULIO ENRIQUE TASCON'),
            ('Satelite    SANTIAGO RENGIFO', 'Satelite    SANTIAGO RENGIFO'),
            ('Satelite    SOFIA CAMARGO', 'Satelite    SOFIA CAMARGO'))),
        ('JOSE MARIA CARBONELL',
            (('Principal JOSE MARIA CARBONELL', 'Principal JOSE MARIA CARBONELL'),
            ('Satelite HONORIO VILLEGAS', 'Satelite HONORIO VILLEGAS'))),
        ('MARICE SINISTERRA',
            (('Principal MARICE SINISTERRA', 'Principal MARICE SINISTERRA'),
            ('Satelite FENALCO ASTURIAS', 'Satelite FENALCO ASTURIAS'))),
            ('Principal IE BOYACA', 'Principal IE BOYACA'),
            ('Principal YUMBO-IE MAYOR DE YUMBO - SEDE PRINCIPAL', 'Principal YUMBO-IE MAYOR DE YUMBO - SEDE PRINCIPAL'),
            ('Principal YUMBO-IE JOSE MARIA CORDOBA - SEDE PRINCIPAL', 'Principal YUMBO-IE JOSÉ MARÍA CÓRDOBA - SEDE PRINCIPAL'),
            ('Principal YUMBO-IE TITAN - SEDE PRINCIPAL', 'Principal YUMBO-IE TITAN - SEDE PRINCIPAL'),
