...
urlpatterns += patterns('convocat2.views.dashboard',
    url(r'^convocat2/resultados$',      'dashboard', name="dashboard"),
    url(r'^convocat2/resultadosME$',      'reporteME', name="reporteME"),
    url(r'^convocat2/impresionME/(\d+)$',      'impresionME', name="impresionME"),
    url(r'^convocat2/tablero_control/(\d*)$', 'tablero_control', name="tablero_control"),
    url(r'^convocat2/tablero_control/actividades/(\d*)$', 'actividades', name="tableroControlActividades"),
    url(r'^convocat2/tablero_control/guardarArchivos$', 'guardarArchivo', name="tableroControlGuardarArchivo"),
    url(r'^convocat2/tablero_control/guardarEstadoDeAvance$', 'guardarEstadoDeAvance', name="tableroControlGuardarEstadoDeAvance"),
    url(r'^convocat2/tablero_control/guardarGrupo/(\d*)$', 'guardarGrupo', name="tableroControlGuardarGrupo"),
    url(r'^convocat2/tablero_control/guardarVariablesPorAula$', 'guardarVariablesPorAula', name="tableroControlGuardarVariablesPorAula"),
    url(r'^convocat2/tablero_control/guardarVariablesPorSede$', 'guardarVariablesPorSede', name="tableroControlGuardarVariablesPorSede"),
    url(r'^convocat2/tablero_control/eliminarGrupo/(\d*)$', 'eliminarGrupo', name="tableroControlEliminarGrupo"),
    url(r'^convocat2/tablero_control/eliminarArchivo/(\d*)$', 'eliminarArchivo', name="tableroControlEliminarArchivo"),
    url(r'^convocat2/obtenerGruposPorConceptoActividad/(\d*)$', 'obtenerGruposPorConceptoActividad', name="tableroControlObtenerGruposPorConceptoActividad"),
)
