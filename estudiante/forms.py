...
class InfoLaboralForm(forms.ModelForm):
    class Meta:
        model = InfoLaboral
        fields = ('secretaria_educacion', 'sede', 'cargo', 'zona', 'jornada', 'grados', 'asignaturas', 'otra_asignatura', 'decreto_docente', 'nombramiento', 'tipo_etnoeducador', 'poblacion_etnica', 'detalles')
        widgets = {
