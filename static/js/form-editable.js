...
var handleEditableFieldConstruct = function() {
    ...
    $('a[class^="campofecha"]').editable();
    $('a[class^="campometa"]').editable();
    $('a[class^="campoavance"]').editable();
    $('a[class^="campopresupuestoactividad"]').editable();
    $('a[class^="campopresupuestoejecutado"]').editable();
    $('a[class^="campoejecucionfinanciara"]').editable();
